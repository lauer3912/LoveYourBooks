...
* [Rust快速入门](quickstart/quickstart.md)
  ...
  * [原生类型](quickstart/primitive.md)
    * [布尔类型](quickstart/primitive-type/bool-types.md)
    * [数值类型](quickstart/primitive-type/number-types.md)
    * [字符类型](quickstart/primitive-type/char-types.md)
    * [字符串类型](quickstart/primitive-type/string-types.md)
    * [数组类型](quickstart/primitive-type/array-types.md)
    * [切片类型](quickstart/primitive-type/-types.md)
...
* [可变性、所有权、租借和生命期](ownership-system/preface.md)
